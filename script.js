...
const translations = {
  en: {
    ...
    heroEyebrow: "Technical Support • Customer Success • Future TAM",
    heroTitle:
      "Customer-first technical support professional growing toward Technical Account Management.",
    heroText:
  ...
  es: {
    ...
    heroEyebrow: "Soporte Técnico • Éxito del Cliente • Futuro TAM",
    heroTitle:
      "Profesional de soporte técnico enfocado en el cliente y en crecimiento hacia Technical Account Management.",
    heroText:
